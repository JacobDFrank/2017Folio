  ...
  SubscribeForm.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        status === "success" && React.createElement("p", { style: styles.success, dangerouslySetInnerHTML: { __html: messages.success || msg } }),
        status === "error" && React.createElement("p", { style: styles.error, dangerouslySetInnerHTML: { __html: messages.error || msg } })
      )
    );
  };
